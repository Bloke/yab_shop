...
yab_shop_checkout_required_field_notice => <p>If you do not already have an account, you may create one by choosing a login name in the form yab_shop_below. Having an account will entitle you to discount special offers and promotions, as well as being the first to get hold of the yab_shop_latest news and offers.</p><p>You can either enter your details below to save them with your account, or skip it and go straight to yab_shop_PayPal. Note that PayPal accept credit/debit cards too. If you have problems with the shop, please <a href="/contact">get in touch by e-mail</a> or call <txp:output_form form="phone_number" />.</p>
